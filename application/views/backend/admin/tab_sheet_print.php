<?php 
	...
	$students_name=$this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->name;
...
<div id="print">
	...
	<center>
		<img src="uploads/logo.png" style="max-height : 60px;float: left"><br><br>
		<p style="float: left;font-size: 10pt;">Aut N° 00118 / MESSUCURRS</p><br>
		<p style="float: left;font-size: 10pt;">Ministere de l'interieur</p>
		<h3 style="font-weight: 100;"><?php echo $system_name;?></h3>
		<h2 style="font-weight: 100;float: left;color: red">Excelence Integrité Leader Sheep</h2><br><br><br>
		
		<div style="float: left;margin-left: -300px;">
		<?php echo get_phrase('Anne Universitaire') . ' : ' . $running_year;?><br>
		<?php echo get_phrase('N° D\'identification') . ' : ' . $class_name;?><br>
		<?php echo get_phrase('Prenom et Nom') . ': ' . $students_name;?><br>
		<?php echo get_phrase('Date et lieu de Naissance'). ' : ' . $class_name;?><br>
	...
	<table style="width:100%; border-collapse:collapse;border: 1px solid #ccc; margin-top: 10px;" border="1">
		<thead>
			...
			<td style="text-align: center;">
				<?php echo get_phrase('Filieres');?> <i class="fa fa-arrow-circle-right"></i>
			</td>
			
			<td style="text-align: center;"><?php echo get_phrase('Specialite');?></td>
			</tr>
