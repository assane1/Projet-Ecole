	...
	<div class="col-sm-12">
        <div class="panel panel-info" data-collapsed="0">
            <div class="panel-heading">
               ...
               <div class="white-box">
               <div class="table-responsive" id="printdoc">
  ...
  <?php 
    ...
    <tr>
        ...
        <td colspan=5 align="center" valign=middle><b><u><font face="Cambria" color="#000000">Le Directeur des Etudes</font></u></b></td>
                ...
                <!-- Fin test-->
                <table class="table table-bordered info-table table-stripped table-condensed" >
                        <thead >
                                <tr style="height: auto;">
                                        <th style="text-align: center;background-color: #ccc;border: 1px solid;width: 100%"><strong>BULLETIN DE NOTES</strong></th>
                                </tr>
                   ...
                   <table class="table table-bordered info-table table-stripped table-condensed">
                       <thead>
                        <tr style="background-color: pink;height: auto;">
                            <td style="text-align: center;" ><strong><?php echo get_phrase('Unités d\'enseignements');?></strong></td>
                            <!--
                            <td style="text-align: center;"><strong><?php //echo get_phrase('Teacher');?></strong></td>
                    -->
                            <td style="text-align: center;"><strong>MOY.CONT <br>/20*40%</strong></td>
                            <td style="text-align: center;"><strong>Examen <br>/20*60%</strong></td>
                            <td style="text-align: center;"><strong>MOY <br>/20</strong></td>
                            <td style="text-align: center;"><strong>Moy UE</strong></td>
                            <td style="text-align: center;"><strong>CR</strong></td>
                            <td style="text-align: center;"><strong>CR UE</strong></td>
                            <td style="text-align: center;"><strong>MCR</strong></td>
                            <td style="text-align: center;"><strong>Appréciations</strong></td>
                            <!--
                    ...
                    <tbody>
                            ...
                            <tr>
                                <td style="text-align: center;border: 1px solid;height:auto;"><strong style="width: 100%;color: blue;"><?php  echo $row3['name'];?></strong><br>
                                        <span><?php  echo $row3['la1'];?></span><br>
                                        <?php  echo $row3['la2'];?><br>
                                        <?php  echo $row3['la3'];?><br>
                                        <?php  echo $row3['la4'];?><br>

                                </td>
                                <!--
                                <td style="text-align: center;"><?php //echo $this->crud_model->get_type_name_by_id('teacher', $row3['teacher_id']); ?></td>
                        -->
                                <td style="text-align: center;border: 1px solid;height: auto;">
                                ...
                                <td style="text-align: center;border: 1px solid;height: auto;">
                                    <?php foreach ($marks as $row4)
                                     echo "</br>";
                                     echo ($row4['labtotal']-$row4['labnueve'])*0.4+($row4['labnueve']*0.6);
                                         echo "</br>";
                                ...
                                <td style="text-align: center;height: 50px;border: 1px solid;height: auto;">
                                    <?php foreach ($marks as $row4)
                                     echo "</br>";
                                     echo $row4['labtres'];
                                      echo "</br>";
                ...
                <button class="btn btn-info" type="button" id="print" onclick="printDiv()">Imprimer le bulletin</button>
        </div>  
	</div>
</div>
</div>
